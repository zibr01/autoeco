    ...
    try {
      ...
      if (result?.error) {
        ...
        if (userRole !== "BUSINESS") {
          ...
          setError("Этот аккаунт не является бизнес-аккаунтом");
          setLoading(false);
          return;
        }
  ...
  return (
    <div className="min-h-screen bg-bg flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        {/* Logo */}
        <Link href="/b2b" className="flex items-center justify-center gap-2.5 mb-8 group">
        ...
        <div className="card-surface">
          <div className="text-center mb-6">
            <h1 className="text-xl font-bold text-text">Вход в AutoEco Business</h1>
            <p className="text-text-muted text-sm mt-1">
              Войдите в панель управления бизнесом
            </p>
          </div>
